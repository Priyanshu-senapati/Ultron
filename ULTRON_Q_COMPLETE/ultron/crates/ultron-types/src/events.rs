...
pub enum UltronEvent {
    ...
    WindowChanged {
        ...
        pid: u32,
        hwnd: i64,
        /// Coarse classification of the owning process (Fix 4). `None` if
        /// the user's config didn't map this executable to a category.
        app_category: Option<crate::perception::AppCategory>,
        ts_unix_ms: i64,
    },
...
mod tests {
    ...
    fn window_changed_serde_tag() {
        let e = UltronEvent::WindowChanged {
            ...
            pid: 4242,
            hwnd: 0xDEAD,
            app_category: Some(crate::perception::AppCategory::Coding),
            ts_unix_ms: 1_700_000_000_000,
        };
        let v: serde_json::Value = serde_json::to_value(&e).unwrap();
        assert_eq!(v["type"], "window_changed");
        assert_eq!(v["pid"], 4242);
        assert_eq!(v["app_category"], "coding");
    }
