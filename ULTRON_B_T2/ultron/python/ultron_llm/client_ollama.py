...
class OllamaClient:
    ...
    async def chat_with_images(
        ...
        Used for on-demand screen-reading: capture screen, base64-encode,
        ask the question with the image as context. LLaVA returns a
        textual answer grounded in what's actually on screen, instead of
        the model hallucinating about not having vision tools.
        """
        payload = {
            "model": model,
            "messages": [
