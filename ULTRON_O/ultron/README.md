...
- [ ] **Module O Rust sidecar** (`ultron-insight-pulse` crate) — pending Turn 2
- [ ] **Module O Python sidecar** (`insight_pulse.py` LLaVA inference) — pending Turn 3
- [ ] **Module Q**: Ghost Network — paused; wire types written but runtime pending

Next: **Module O Rust sidecar (Turn 2)**, then the Python LLaVA sidecar + tests (Turn 3).
