...
$PyProcs = @(
    ...
    @{ Tag = 'dream-service';     Script = "$PY_DIR\dream_service.py" },
    @{ Tag = 'emotion-env';       Script = "$PY_DIR\emotion_env_service.py" },
    @{ Tag = 'context-tunnel';    Script = "$PY_DIR\context_tunnel_service.py" },
    @{ Tag = 'focus-shield';      Script = "$PY_DIR\focus_shield_service.py" },
