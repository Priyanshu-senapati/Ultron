...
_ULTRON_FOCUS_HINTS = (
    "python.exe", "powershell.exe", "pwsh.exe", "windowsterminal.exe",
    "conhost.exe", "cmd.exe",
    "ultron-core", "ultron-insight", "ultron-memory", "ultron-ghost", "ultron",
)
...
class ContextAssembler:
    ...
    def assemble(
        ...
        # Focus selection cascade (skip ULTRON's own terminals).
        focus_app: str
